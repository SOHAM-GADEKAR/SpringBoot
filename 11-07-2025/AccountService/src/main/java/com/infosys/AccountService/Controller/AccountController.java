...
public class AccountController {
    ...
    @GetMapping("/getaccountcustomerdetails/{id}")
    public AccountCustomerDetails getAccountCustomerDetails(@PathVariable Long id) {
        return service.getAccountCustomerDetails(id);
